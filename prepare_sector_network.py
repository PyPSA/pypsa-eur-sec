...
def add_emission_prices(n, emission_prices=None, exclude_co2=False):
    ...
    if emission_prices is None:
        emission_prices = 0#snakemake.config['costs']['emission_prices']
    ...
    for name in ["residential rural","services rural","residential urban decentral","services urban decentral","urban central"]:
        ...
        if options["chp"]:
            ...
            if name == "urban central":
                ...
                # changed 
                if "micro CHP" in costs.index:
                    efficiency = costs.at['micro CHP','efficiency']
                    efficiency2 = costs.at['micro CHP','efficiency-heat']
                    capital_cost = costs.at['micro CHP','fixed']
                else:
                    print("WARNING: micro CHP not found in costs, assume mean" +  
                          " values for capital cost and efficiency\n")
                    efficiency = costs['efficiency'].mean()
                    efficiency2 = costs['efficiency'].mean()
                    capital_cost = costs['fixed'].mean()
                network.madd("Link",
...
if __name__ == "__main__":
    ...
    # for testing
#    snakemake.input.network="/home/ws/bw0928/Dokumente/pypsa-eur/networks/elec_s_2.nc"
    ...
    # for testing
#    snakemake.input.clustered_pop_layout = "/home/ws/bw0928/Dokumente/pypsa-eur-sec/resources/pop_layout_elec_s_50.csv"
    ...
    # for testing 
#    snakemake.input.costs = "/home/ws/bw0928/Dokumente/pypsa-eur-sec/data/costs.csv"
