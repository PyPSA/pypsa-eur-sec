...
def build_industrial_demand():
    ...
    industrial_demand_per_country = pd.read_csv(
        snakemake.input.industrial_demand_per_country, index_col=0)

    industrial_demand = industrial_demand_per_country.loc[pop_layout.ct].fillna(
        0.)
